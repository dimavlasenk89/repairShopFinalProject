...
<table class="table table-bordered">
    ...
    <c:forEach var="orders" items="${ListOrdersByCustomer}">
        ...
        <tr>
            ...
            <td>
                <c:out value="${orders.customerLogin}" />
            </td>
            <td>
                <c:out value="${orders.masterLogin}" />
            </td>
            <td>
                <c:out value="${orders.carType}" />
            </td>
            <td><a href="edit?id=<c:out value='${orders.id}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="delete?id=<c:out value='${orders.id}' />">Delete</a></td>
        </tr>
    </c:forEach>
    <!-- } -->
    </tbody>
...
<%--        <form method="get" action="allCustomersServlet" class="row g-3">--%>
<%--            <div class="col">--%>
