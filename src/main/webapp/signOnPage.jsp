...
<div class="container">
    ...
    <div class="row">
        ...
        <form method="get" action="addCustomerServlet" class="row g-3">
            <div class="col">
    <input name="login" type="login" class="form-control" id="exampleFormControlInput1" placeholder="Створіть логін">
            </div>
            <div class="col">
                <input name="password" type="password" class="form-control" id="inputPassword2" placeholder="Створіть пароль">
            </div>
            <div class="col">
                <input type="submit" class="btn btn-primary mb-3" value="Зареєструватись">
